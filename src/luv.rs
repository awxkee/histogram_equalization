...
use colorutils_rs::{ColorError, ImageBuffer, ImageBufferMut, Luv, Rgb};
        ...
        .for_each(|(dst, src)| {
            ...
            if image_configuration.has_alpha() {
                    ...
                    .zip(src.as_chunks::<4>().0.iter())
                {
                    ...
                    dst[1] = (luv.u * 100f32 + 100f32).round() as u16;
                    dst[2] = (luv.v * 100f32 + 100f32).round() as u16;
...
pub(crate) fn rgb_to_luv(
    ...
    generic_image_to_luv::<{ ImageConfiguration::Rgb as u8 }>(src, dst, scale)
}
...
pub(crate) fn bgra_to_luv(
    ...
    generic_image_to_luv::<{ ImageConfiguration::Bgra as u8 }>(src, dst, scale)
}
...
pub(crate) fn rgba_to_luv(
    ...
    generic_image_to_luv::<{ ImageConfiguration::Rgba as u8 }>(src, dst, scale)
}
...
pub(crate) fn luv_to_rgb(
    ...
    luv_to_generic_image::<{ ImageConfiguration::Rgb as u8 }>(src, dst, scale)
}
...
pub(crate) fn luv_to_bgra(
    ...
    luv_to_generic_image::<{ ImageConfiguration::Bgra as u8 }>(src, dst, scale)
}
...
pub(crate) fn luv_to_rgba(
    ...
    luv_to_generic_image::<{ ImageConfiguration::Rgba as u8 }>(src, dst, scale)
}
