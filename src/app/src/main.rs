...
use histogram_equalization::{clahe_jzazbz_bgra, clahe_jzazbz_rgb, clahe_lab_bgra, clahe_lab_rgb, clahe_luv_bgra, clahe_luv_rgb, clahe_oklab_bgra, clahe_oklab_rgb, clahe_oklab_rgba, clahe_oklch_bgra, clahe_yuv_bgra, clahe_yuv_rgb, ClaheGridSize};
